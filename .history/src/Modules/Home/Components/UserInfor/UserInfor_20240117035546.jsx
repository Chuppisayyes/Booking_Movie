                ...
                <Grid item xs={4} className={style.jss2}>
                    ...
                    <div className={style.jss3}>
                        <div className={style.jss4}>
                            <h4>Tài Khoản :</h4>
                            <p style={{ marginLeft: '10px', fontWeight:"700", fontSize:"20px" }}>{accountInfor?.taiKhoan}</p>
                        </div>
                        <div style={{ display: 'flex' }}>
                            <h4>Mật Khẩu :</h4>
                            <p style={{  marginLeft: '10px', fontWeight:"700", fontSize:"20px" }}>{accountInfor?.matKhau}</p>
                        </div>
                        <div className={style.jss4}>
                            <h4>Họ Tên :</h4>
                            <p style={{  marginLeft: '10px', fontWeight:"700", fontSize:"20px" }}>{accountInfor?.hoTen}</p>
                        </div>
                        <div style={{ display: 'flex' }}>
                            <h4>Email :</h4>
                            <p style={{  marginLeft: '10px', fontWeight:"700", fontSize:"20px" }}> {accountInfor?.email}</p>

                        </div>
                        <div className={style.jss4} style={{ display: 'flex' }}>
                            <h4>Số Điện Thoại :</h4>
                            <p style={{  marginLeft: '10px', fontWeight:"700", fontSize:"20px" }}> {accountInfor?.soDt}</p>
