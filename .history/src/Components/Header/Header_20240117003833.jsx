...
export default function Header() {
  ...
  const handleScroll = (id) => {
    ...
    // Sử dụng useHistory để điều hướng trang
    const history = useHistory();
    
    // Nếu không phải là trang home, quay về trang home trước
    if (history.location.pathname !== '/') {
      history.push('/'); // Điều hướng về trang home
    }
  
    // Cuộn xuống phần có id tương ứng
